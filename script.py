...
if __name__ == "__main__":
    ok = test_exchange_connection()
    if ok:
        print("🎉 Status: CONNECT OK. Có thể tiếp tục làm bước đọc email / download attachment.")
    else:
        print("🚫 Status: CONNECT FAIL. Cần kiểm tra lại cấu hình / network / auth.")